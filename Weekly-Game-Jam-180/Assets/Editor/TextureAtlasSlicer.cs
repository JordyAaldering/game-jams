                ...
                importer.textureType != TextureImporterType.Default);
            {
                ...
                if (xmlAsset != null && needsToResizeTexture) {
                    EditorGUILayout.LabelField(
                        string.Format("Texture size too small. It needs to be at least {0} by {1} pixels!",
                ...
                EditorGUI.BeginDisabledGroup(xmlAsset == null || needsToResizeTexture
                    || subTextures == null || subTextures.Length == 0);
